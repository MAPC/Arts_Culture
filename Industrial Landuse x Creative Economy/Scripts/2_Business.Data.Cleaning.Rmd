...
data.axle_arts.spaces <- data.axle_clean.geocoded |> 
  filter(
...
write.csv(
  ...
  "C:/Project_Work/Local_Data/Arts_Culture/Industrial_Land_Use/Data/Tabular/intermediary/DA.23_MAPC.cleaned.geocoded.csv",
  row.names = F
)

saveRDS(
  data.axle_arts.spaces_mapc,
  file = "C:/Project_Work/Local_Data/Arts_Culture/Industrial_Land_Use/Data/Tabular/intermediary/DA.23_MAPC.cleaned.geocoded.rds"
)
```
