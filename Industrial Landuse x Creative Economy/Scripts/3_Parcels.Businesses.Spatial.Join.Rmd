...
# Individual municipalities - It depends! Some do not exhibit clustering phenomenon, some do! Some places the clusters are concentrated - I stat closer to 1, others more dispersed - i stat closer to -1. And some places where the businesses tend not to be evenly spread throughout the parcels in the municipality.
